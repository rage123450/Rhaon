...
CTRMiniGameQuestion_NpcView::CTRMiniGameQuestion_NpcView() : CTRMiniGameQuestion(Question_NPCVIEW)
{
}

CTRMiniGameQuestion_NpcView::~CTRMiniGameQuestion_NpcView()
{
}

void CTRMiniGameQuestion_NpcView::Update(float fElapsed)
{
	m_diceObjView.frameMove(fElapsed);
}

void CTRMiniGameQuestion_NpcView::Init(CGUIDialog* _pDlg, std::string _strCtrlName, std::string _strModelName, std::string _strAnimationName, std::tuple<float, float> _tupleRadius, float _fFovy)
{
...
void CTRMiniGameQuestion_NpcView::ChangeUserView(string _strPartGroupName, string _strAnimationName)
{
